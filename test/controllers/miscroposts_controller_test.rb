...
class MiscropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create miscropost" do
    assert_difference('Miscropost.count') do
      post miscroposts_url, params: { miscropost: { content: @miscropost.content, user_id: @miscropost.user_id } }
    end
  ...
  test "should update miscropost" do
    patch miscropost_url(@miscropost), params: { miscropost: { content: @miscropost.content, user_id: @miscropost.user_id } }
